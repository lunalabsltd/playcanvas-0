...
uniform vec4 unity_SpecCube0_TexelSize;

uniform samplerCube unity_SpecCube1;
uniform vec4 unity_SpecCube1_TexelSize;
...
void addReflection() {
    ...
    vec3 env0 = SampleGlossyEnvironment( unity_SpecCube0, unity_SpecCube0_TexelSize, unity_SpecCube0_HDR, r0 );
    ...
    if ( blendLerp < kBlendFactor ) {
        ...
        vec3 env1 = SampleGlossyEnvironment( unity_SpecCube1, unity_SpecCube1_TexelSize, unity_SpecCube1_HDR, r1 );
